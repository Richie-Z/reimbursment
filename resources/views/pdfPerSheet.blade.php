@foreach ($records as $record)
    ...
    <div style="display: flex; flex-direction: Column;">
        <!-- Left Column: Text Details Section -->
        <div style="width: 20%; height: 20%; padding: 10px; border: 1px solid #000; vertical-align: top;">
        ...
        <!-- Right : Image Section -->
        <div style="width: 50%; padding: 10px; text-align: center; vertical-align: top;">
